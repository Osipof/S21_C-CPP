...
START_TEST(s21_subTest29) {
  ...
  s21_decimal d = {{3, 0, 0, 0}};
  s21_decimal etalon = {{UINT32_MAX - 3, UINT32_MAX, 0, 0}};
...
START_TEST(s21_test_decimal_sub_simple_4) {
...
START_TEST(s21_test_decimal_sub_simple_5) {
...
START_TEST(s21_test_decimal_sub_simple_6) {
  s21_decimal c = {{100, 0, 0, 0}};
